...
class ErrorCode:
    ...
    REPAIR_MODULE_IMPORT_FAILED = "REPAIR_MODULE_IMPORT_FAILED"
    MODEL_STATE_LOAD_FAILED = "MODEL_STATE_LOAD_FAILED"
    REPAIR_FAILED = "REPAIR_FAILED"
    SCAN_FAILED = "SCAN_FAILED"
    REPAIR_BATCH_FAILED = "REPAIR_BATCH_FAILED"
    ...
    def all(cls) -> set[str]:
        return {
            ...
            cls.TRAINING_FAILED,
            cls.REPAIR_MODULE_IMPORT_FAILED,
            cls.MODEL_STATE_LOAD_FAILED,
            cls.REPAIR_FAILED,
            cls.SCAN_FAILED,
            cls.REPAIR_BATCH_FAILED,
            cls.ROLLBACK_FAILED,
            cls.INTERNAL_ERROR,
        }
